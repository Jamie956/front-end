...
/***/ (function(module, exports, __webpack_require__) {
		...
		_createClass(Header, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement("input", { value: this.props.title, onChange: this.handleChange.bind(this) })
				);
			}
		}]);
	...
	var Layout = function (_React$Component2) {
		...
		function Layout() {
			...
			var _this2 = _possibleConstructorReturn(this, (Layout.__proto__ || Object.getPrototypeOf(Layout)).call(this));

			_this2.state = { title: "Here We Go!" };
			return _this2;
		}
		...
		_createClass(Layout, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					null,
					_react2.default.createElement(Header, { changeTitle: this.changeTitle.bind(this), title: this.state.title })
				);
			}
		}]);
